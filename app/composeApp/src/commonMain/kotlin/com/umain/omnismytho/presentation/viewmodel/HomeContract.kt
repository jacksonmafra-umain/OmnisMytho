...
sealed interface HomeEvent : RevolverEvent {
    ...
    data class OnMythologyClicked(val mythologyId: String) : HomeEvent
    data object OnSearchClicked : HomeEvent
}

sealed interface HomeState : RevolverState {
    data object Loading : HomeState
    data class Loaded(val mythologies: List<Mythology>) : HomeState
    data class Error(val message: String) : HomeState
}

sealed interface HomeEffect : RevolverEffect {
    data class NavigateToCatalog(val mythologyId: String) : HomeEffect
