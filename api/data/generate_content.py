...
def main():
    mythologies = [
        ...
        "Roman Mythology",
        "Celtic Mythology",
        "Mesopotamian Mythology (Sumerian, Babylonian, Assyrian)",
        "Chinese Mythology",
        "Slavic Mythology",
        "Aztec Mythology",
        "Mayan Mythology",
        ...
        "Aboriginal Australian Mythology (Dreamtime)",
        "Yoruba & West African Mythology",
        "Vodou & Caribbean Syncretic Mythology",
        "Persian / Zoroastrian Mythology",
        "Korean Mythology",
        "Tibetan & Bon Mythology",
